...
export default function Home() {
  ...
  return (
    <div className={"min-h-screen bg-[#effafa]"}>
      ...
      <div className={`relative flex flex-col gap-y-[40px] px-6 lg:gap-y-6 lg:px-[165px] lg:pt-[76px]`}>
        ...
        <div className={`flex flex-col gap-y-[40px] lg:gap-y-6 ${hasFilters ? "-mt-[19px]" : "pt-[56px]"}`}>
